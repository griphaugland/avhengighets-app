...
import { TextInput, Text, View, AppState, TouchableOpacity } from 'react-native'
...
export default function SignUp({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.centerContainer}>
      ...
      <View style={styles.verticallySpaced}>
        <TouchableOpacity style={styles.button} title="Registrer" disabled={loading} onPress={() => signUpWithEmail()}>
